...
const IntroduceLeft = ({title, ...props}) => {
    ...
    return (
        <div className='w-full mx-auto py-12 relative'>
            ...
            <div className='flex sm:flex-col-reverse sm:gap-3 sm:w-[90%] md:flex-row lg:w-[85%] mx-auto relative justify-end'>
                <div className='sm:p-10 sm:w-full md:w-[60%] lg:w-1/2 md:p-10 md:pr-28 md:absolute left-0 top-[10%] border-solid border-[#C09B5A] border-[1px] rounded-xl'>
                    <div>
                ...
                <div className='sm:w-full md:w-1/2 lg:w-[55%] '>
